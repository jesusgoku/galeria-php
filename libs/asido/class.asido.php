...
Class Asido {
	...
	* @static
	*/
	Public Static Function resize(asido_image $image, $width, $height, $mode=ASIDO_RESIZE_PROPORTIONAL) {
	...
	* @static
	*/
	Public Static Function width(asido_image $image, $width) {
		return asido::_operation(
				$image, 'resize',
				array(
					'width' => $width,
	...
	* @static
	*/
	Public Static Function height(asido_image $image, $height) {
		return asido::_operation(
				$image, 'resize',
				array(
					'width' => 0,
	...
	* @static
	*/
	Public Static Function stretch(asido_image $image, $width, $height) {
		return asido::_operation(
				$image, 'resize',
				array(
					'width' => $width,
	...
	* @static
	*/
	Public Static Function fit(asido_image $image, $width, $height) {
		return asido::_operation(
				$image, 'resize',
				array(
					'width' => $width,
	...
	* @static
	*/
	Public Static Function frame(asido_image $image, $width, $height, $color=null) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'width' => $width,
	...
	* @static
	*/
	Public Static Function convert(asido_image $image, $mime_type) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'mime' => $mime_type
	...
	* @static
	*/
	Public Static Function watermark(asido_image $image, $watermark_image,
	...
	* @static
	*/
	Public Static Function grayscale(asido_image $image) {
		return asido::_operation(
				$image, __FUNCTION__,
				array()
			);
	...
	* @static
	*/
	Public Static Function rotate(asido_image $image, $angle, $color=null) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'angle' => $angle,
	...
	* @static
	*/
	Public Static Function copy(asido_image $image, $applied_image, $x, $y) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'image' => $applied_image,
	...
	* @static
	*/
	Public Static Function crop(asido_image $image, $x, $y, $width, $height) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'x' => $x,
	...
	* @static
	*/
	Public Static Function flip(asido_image $image) {
		return asido::_operation(
				$image, __FUNCTION__,
				array()
			);
	...
	* @static
	*/
	Private Static Function _operation(asido_image $image, $operation, $params) {
